...
/*** From source: /home/martin/Desktop/Artifacts/protocol/protocol.pml ***/
...
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "/home/martin/Desktop/Artifacts/protocol/protocol.pml", 1, 4 },
	{ "-", 5, 6 }
};
uchar reached2 [] = {
	  0,   1,   0,   0,   0,   0, };
...
short src_ln1 [] = {
	  0,  27,  28,  29,  30,  31,  32,  34, 
	 34,  35,  35,  36,  36,  33,  38,  38, 
	 39,  40,  42,  43,  43,  41,  45,  45, 
	 46,  47,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "/home/martin/Desktop/Artifacts/protocol/protocol.pml", 1, 25 },
	{ "-", 26, 27 }
};
uchar reached1 [] = {
	  0,   1,   0,   0,   0,   1,   0,   1, 
...
short src_ln0 [] = {
	  0,   5,   6,   7,   8,  10,  10,  11, 
	 11,  12,  12,   9,  14,  14,  15,  16, 
	 18,  19,  19,  17,  21,  21,  22,  23, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "/home/martin/Desktop/Artifacts/protocol/protocol.pml", 1, 23 },
	{ "-", 24, 25 }
};
uchar reached0 [] = {
	  0,   0,   0,   1,   0,   1,   1,   1, 
...
{	int j, h = now._nr_pr;
	...
	case 2:	/* :init: */
		...
		/* params: */
		/* locals: */
		((P2 *)pptr(h))->a2b = addqueue(calling_pid, 1, 0);
		((P2 *)pptr(h))->b2a = addqueue(calling_pid, 2, 0);
#ifdef VAR_RANGES
#endif
#ifdef HAS_CODE
		locinit2(h);
	...
	case 1:	/* B */
		...
		((P1 *)pptr(h))->ar = 0;
#ifdef VAR_RANGES
		logval("B:ar", ((P1 *)pptr(h))->ar);
		logval("B:mr", ((P1 *)pptr(h))->mr);
		logval("B:lmr", ((P1 *)pptr(h))->lmr);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* A */
		...
		((P0 *)pptr(h))->vr = 0;
#ifdef VAR_RANGES
		logval("A:vr", ((P0 *)pptr(h))->vr);
		logval("A:mt", ((P0 *)pptr(h))->mt);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->in) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->out) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->out) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->in) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->out) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->out) )))
			    ) return 0; break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->a2b) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->a2b) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->a2b) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->a2b) )))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->b2a) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->b2a) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->b2a) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->b2a) )))
			    ) return 0; break;
...
{	/* int i; */
	...
	printf("	chan a2b (=%d):	len %d:\t", ((P2 *)pptr(pid))->a2b, q_len(((P2 *)pptr(pid))->a2b));
	c_chandump(((P2 *)pptr(pid))->a2b);
	printf("	chan b2a (=%d):	len %d:\t", ((P2 *)pptr(pid))->b2a, q_len(((P2 *)pptr(pid))->b2a));
	c_chandump(((P2 *)pptr(pid))->b2a);
		break;
	case 1:
