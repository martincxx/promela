...
#define _nstates1	7	/* env */
#define minseq1	6
#define maxseq1	11
#define _endstate1	6

#define _nstates0	7	/* counter */
#define minseq0	0
#define maxseq0	5
#define _endstate0	6
...
#define Pcounter	((P0 *)this)
typedef struct P0 { /* counter */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
